...
**reims-vgpu** — сабмодуль, изменения живут патчами `patches/reims-vgpu/0003…0011`.
В рабочем дереве сабмодуля они уже применены. На свежем клоне:
`git submodule update --init reims-vgpu`, затем `git apply` 0003, 0004, 0005, 0006, 0007, 0008, 0009, 0010, 0011 по порядку.
