...
enum L10n {
    ...
    private static let pairs: [(String, String)] = [
        ...
        ("Приложение неофициальное и никак не связано с Apple. Аватарки берутся с GitHub — у X открытого способа их получить нет.",
            "This app is unofficial and not affiliated with Apple. The avatars come from GitHub — X has no open way to fetch them."),
