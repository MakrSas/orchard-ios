        ...
        Form {
            if VMConfig.macGuest {
                ...
                Section {
                    ...
                    Text(L("Папка Shared в «Файлах» → Orchard доступна гостю по сети, по адресу http://10.0.2.2:8080. Из Терминала гостя: «curl -O http://10.0.2.2:8080/файл» забирает файл с телефона, «curl -T файл http://10.0.2.2:8080/» кладёт его на телефон. Скорость — как у сети гостя, порядка 15 МБ/с."))
                }
            } else {
                Section {
